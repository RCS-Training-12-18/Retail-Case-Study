...
update sales_fact_1997 set last_update = UNIX_TIMESTAMP(NOW());
alter table sales_fact_1998 add last_update INT;
update sales_fact_1998 set last_update = UNIX_TIMESTAMP(NOW());
